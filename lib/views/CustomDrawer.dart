...
//  constructor for getting attributes
  CustomDrawer(List<Map<String, dynamic>> families, Map<String, dynamic>? userData, {super.key});
                          ...
                          return Column(
                            ...
                            children: [
                              ListTile(
                                  ...
                                  onTap: () {
                                     Navigator.pop(context, _familyNameController );
                                    print(
                                        "tapped on $family");
                                  }),
